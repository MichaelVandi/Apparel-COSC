  ...
  handleTextChange(event){
    ...
    updateName=()=>{
        ...
        if(!this.state.nameField==''){
          ...
          temporaryReference.child('Desc').once('value', function(snapshot){
            if(snapshot.exists()){
             ...
             var message="Item Description Updated Successfully!";
        var cancelled='phone';
    ...
    render() {
        ...
        animationType="slide"
          ...
          <View>
            ...
            <Text style={{fontWeight:'bold', marginBottom: 4}}>Describe the item:</Text>
