  ...
  handleTextChange(event){
    ...
    updateName=()=>{
        ...
        if(!this.state.nameField==''){
          ...
          temporaryReference.child('Sex').once('value', function(snapshot){
            if(snapshot.exists()){
             ...
             var message="Item Sex Successfully!";
        var cancelled='skills';
    ...
    render() {
        ...
        animationType="slide"
          ...
          <View>
            ...
            <Text style={{fontWeight:'bold', marginBottom: 4}}>Sex</Text>
