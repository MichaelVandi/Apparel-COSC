  ...
  handleTextChange(event){
    ...
    updateName=()=>{
        ...
        if(!this.state.nameField==''){
          ...
          temporaryReference.child('Price').once('value', function(snapshot){
            if(snapshot.exists()){
             ...
             var message="Item Price Updated Successfully!";
        var cancelled='email';
    ...
    render() {
        ...
        animationType="slide"
          ...
          <View>
            ...
            <Text style={{fontWeight:'bold', marginBottom: 4}}>Price:</Text>
