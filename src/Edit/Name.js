...
class Name extends Component {
    constructor(props){
        ...
        this.state={
            ...
            isErrorVisible:false, nameField:'', temporaryReference:null
        }
    }
    componentDidMount(){
  ...
  handleTextChange(event){
    ...
    updateName=()=>{
      ...
      var temporaryReference= this.state.temporaryReference;
          ...
          temporaryReference.child('Title').once('value', function(snapshot){
            if(snapshot.exists()){
             ...
             var message="Item Title Updated Successfully!";
        var cancelled='name';
        ...
        animationType="slide"
          ...
          <View>
            ...
            <input 
              ...
              placeholder ="Enter the item title here"
