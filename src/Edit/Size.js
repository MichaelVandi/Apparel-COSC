...
class Size extends Component {
    constructor(props){
        ...
        this.state={
            ...
            isErrorVisible:false, nameField:'', itemId:'', temporaryReference:null
        }
    }
    componentDidMount(){
      var temporaryReference= this.props.temporaryReference;
  ...
  handleTextChange(event){
    ...
    updateName=()=>{
        ...
        if(!this.state.nameField==''){
          ...
          var temporaryReference= this.state.temporaryReference;
          ...
          temporaryReference.update({
            Size: this.state.nameField
          })
          .catch((error)=>{
            this.setState({
              isErrorVisible: true,
          ...
          temporaryReference.child('Size').once('value', function(snapshot){
            if(snapshot.exists()){
             ...
             var message="Item Size Updated Successfully!";
        var cancelled='title';
    ...
    render() {
        ...
        animationType="slide"
          ...
          <View>
            ...
            <Text style={{fontWeight:'bold', marginBottom: 4}}>Size:</Text>
            ...
            <input 
              ...
              placeholder ="Enter item size here Here"
              style={{borderColor:'grey', borderWidth: 1, height: 40, width:'auto',margin: 3,
              borderRadius:4}}
              name="name"
